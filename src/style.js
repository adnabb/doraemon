...
.eye {
  width: 1.9em; height: 2.1em; border: var(--border); border-radius: 41%;
  position: absolute; top: -1.4em; background-color: var(--skin-color);
}

.eye::after {
  content: ''; display: block; width: .3em; height: .3em;
...
.nose {
  width: .93em; height: .93em;
  border: var(--border); border-radius: 50%;
  position: absolute; left: 2.73em; top: .5em;
  text-align: center; background: var(--nose-color);
}

.nose::after {
  content: ''; display: inline-block;
  border: .03em solid; width: 0; height: 2.2em;
  position: relative; top: .82em;
}

.mousetache {
  position: relative; top: 1em; right: -.2em;
  width: 6em; height: 2em; padding: 0 .5em;
...
.mouth {
  width: 4.5em; height: 2.2em;
  position: absolute; bottom: .72em; left: .94em;
  border: var(--border); border-radius: 132%;
...
.choker {
  ...
  background: var(--choker-color); text-align: center;
  z-index: 2;
}
...
.bell>.dot {
  width: .26em; height: .22em;
  display: inline-block; vertical-align: .32em;
...
.bell>.dot::after {
  ...
  height: .5em; left: .089em;
}

.bell::before {
  content: ''; position: absolute;
  width: 100%; padding: .023em;
  border: var(--border); left: 0;
  top: .23em; border-left: none; border-right: none;
}

.body {
  width: 10em; margin-left: .5em;
  position: relative; display: flex;
}

.arm {
  width: 1.2em; height: 2.6em;
...
.arm.right {
  transform: rotate(-57deg); top: -.1em;
...
.arm::after {
  ...
  border: var(--border); border-radius: 50%;
  position: absolute; bottom: -.7em; left: -.2em;
  background-color: var(--skin-color);
}
...
.main-body {
  width: 5.6em; height: 4.5em;
  margin-left: .52em; border: var(--border);
...
.main-body::before, .main-body::after {
  content: ''; position: absolute;
  height: 1.1em; width: var(--border-width);
  background-color: var(--clothes-color);
}
...
.belly>.pocket {
  display: inline-block;
  width: 3.4em; height: 1.8em;
  border: var(--border); position: relative; bottom: -2em;
...
.foot {
  width: 3.15em; height: .8em;
  border: var(--border); z-index: 1;
  background-color: var(--skin-color);
  background-image: linear-gradient(45deg, #ddd, #fff 28%, #fff);
